...
@TeleOp(name="Jeff's Four Wheel 0.0.3b", group = "Trash")
public class ThreeMotorArtifactGrabber extends LinearOpMode{
    ...
    public void runOpMode(){
        ...
        allMotors[4] = motorExtendLeft;
        allMotors[5] = motorExtendRight;
